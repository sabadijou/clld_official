...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, dim1, dim2, zero_init_residual=False,
...
def resnet34(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', block=BasicBlock, layers=[3, 4, 6, 3], pretrained=pretrained, progress=progress,
                   **kwargs)
